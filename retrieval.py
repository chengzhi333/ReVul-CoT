...
client = OpenAI(
    ...
    # api_key="sk-2127a9670cc149f69d3722463a1affc4",
...
def generate_explanatory_knowledge(query_code, query_desc, topk_samples):
    ...
    explanatory_knowledge = response.choices[0].message.content
...
if __name__ == "__main__":
    ...
    output_file = "test_all_predicted2.xlsx"
    temp_file = "test_all_predicted_temp2.xlsx"
